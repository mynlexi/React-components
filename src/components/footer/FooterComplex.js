...
class FooterComplex extends Component {
  render() {
      ...
      <footer>
        ...
        <div class="bg-gray-100 pt-2 ">
          <div class="flex pb-5 px-3 m-auto pt-5 border-t text-gray-800 text-sm flex-col md:flex-row max-w-6xl">
            <div class="mt-2">© Copyright {currentYear}. All Rights Reserved.</div>
            <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
              <a href="/#" class="w-6 mx-1"><i class="fab fa-facebook"></i></a>
              <a href="/#" class="w-6 mx-1"><i class="fab fa-linkedin"></i></a>
              <a href="/#" class="w-6 mx-1"><i class="fab fa-instagram-square"></i></a>
              <a href="/#" class="w-6 mx-1"><i class="fab fa-github-square"></i></a>
              <a href="/#" class="w-6 mx-1"><i class="fab fa-twitter-square"></i></a>
            </div>
          </div>
        </div>
    </footer>
